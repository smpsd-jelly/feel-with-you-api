...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.bulkInsert('question', [
      ...
      // 13 - 26 (the new set, status = 2 คำถามหมวดภาวะซึมเศร้า (14 ข้อ))
      {
        id: 13,
      ...
      {
        id: 18,
        question_detail: 'คุณรู้สึกไม่มีแรงจูงใจที่จะทำสิ่งต่าง ๆ หรือไม่?',
        status: 2,
        created_at: now,
        updated_at: now
      },
      ...
      // 27 - 38 (the new set, status = 3 คำถามหมวดความเครียดและความกังวล (12 ข้อ))
      {
        id: 27,
      ...
      {
        id: 29,
        question_detail: 'คุณคิดวนซ้ำเกี่ยวกับปัญหาต่าง ๆ หรือไม่?',
        status: 3,
        created_at: now,
        updated_at: now
      },
